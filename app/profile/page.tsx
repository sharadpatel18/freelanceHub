...
const mockUser = {
  ...
  bio: "Senior Web Developer & UI/UX Designer",
  about: "I'm a passionate web developer and UI/UX designer with over 5 years of experience creating beautiful, functional, and user-friendly digital experiences. I specialize in modern web technologies including React, Next.js, TypeScript, and Figma for design.\n\nMy goal is to help businesses transform their ideas into stunning digital products that not only look great but also provide exceptional user experiences. I believe in clean code, responsive design, and continuous learning.",
  location: "San Francisco, CA",
  timezone: "PST (UTC-8)",
  skills: ["React", "TypeScript", "Next.js", "Node.js", "Figma", "UI/UX Design", "Python", "JavaScript"],
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                    ...
                    <div className="relative">
                      <Avatar className="h-32 w-32 ring-4 ring-primary/20">
                        <AvatarImage src={mockUser.profileImage || "/placeholder-avatar.jpg"} />
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                        <div>
                          ...
                          <p className="text-xl text-muted-foreground mb-2">{mockUser.bio}</p>
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span>Member since {mockUser.createdAt.getFullYear()}</span>
                            </div>
                            {mockUser.isVerified && (
                              <div className="flex items-center gap-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="text-center p-3 rounded-lg bg-gradient-to-r from-yellow-500/5 to-yellow-500/5 border border-yellow-500/10">
                          <div className="text-2xl font-bold text-yellow-500">${mockUser.hourlyRate}</div>
                      ...
                      <Card className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20">
                        ...
                        <CardContent>
                          <div className="text-muted-foreground leading-relaxed whitespace-pre-line">
                            {mockUser.about || "No description provided yet."}
                          </div>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20">
                        ...
                        <CardContent>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-sm">
                              <span>Timezone</span>
                              <span className="font-medium">{mockUser.timezone}</span>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
